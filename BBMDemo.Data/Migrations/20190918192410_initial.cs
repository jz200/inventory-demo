        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryId = table.Column<int>(nullable: false),
                    EnteredDate = table.Column<DateTime>(nullable: false),
                    ItemNumber = table.Column<string>(maxLength: 30, nullable: false),
                    ModifiedDate = table.Column<DateTime>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StyleId = table.Column<int>(nullable: false),
                    LocationId = table.Column<int>(nullable: false),
                    BodyQuantity = table.Column<int>(nullable: true),
                    EnteredDate = table.Column<DateTime>(nullable: false),
                    FrameQuantity = table.Column<int>(nullable: true),
                    ModifiedDate = table.Column<DateTime>(nullable: false),
                    Quantity = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductInventory", x => new { x.ProductId, x.StyleId, x.LocationId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductInventory_Style_StyleId",
                        column: x => x.StyleId,
                        principalSchema: "Production",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductInventory_StyleId",
                schema: "Production",
                table: "ProductInventory",
                column: "StyleId");
        }
